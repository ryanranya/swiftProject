...
extension UIColor {
    ...
    /**
     ...
     - returns : 颜色
     */
    class func withHex(hexInt hex:Int32, alpha:CGFloat = 1) -> UIColor {
    ...
    /**
     ...
     - returns : 颜色
     */
    class func withRGBA(_ red:CGFloat, _ green:CGFloat, _ blue:CGFloat, _ alpha:CGFloat) -> UIColor {
